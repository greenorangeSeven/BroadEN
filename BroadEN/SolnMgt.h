...
@property (copy, nonatomic) NSString *Exec_ManEn;
...
@property (copy, nonatomic) NSString *Lithium;
...
@property (copy, nonatomic) NSString *ReportNo;
@property (copy, nonatomic) NSString *Inhibitor;
@property (copy, nonatomic) NSString *Factory;
@property (copy, nonatomic) NSString *ServDepart;
...
@property (copy, nonatomic) NSString *DensityResult;
...
@property (copy, nonatomic) NSString *ResultOther;
@property (copy, nonatomic) NSString *InspectorSign;
@property (copy, nonatomic) NSString *InspectorSignDate;
@property (copy, nonatomic) NSString *AuditorSign;
@property (copy, nonatomic) NSString *AuditSignDate;
